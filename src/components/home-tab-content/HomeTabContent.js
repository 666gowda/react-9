...
function HomeTabContent() {
    ...
    return (
        <div>
            ...
            <div className='row ms-3'>
                ...
                <div className='col-12' style={{ width: '68%', height: '180px' }}>
                    <div className='row rounded' style={{ width: '100%', height: '82px' }}>
                        ...
                        <div id='revTab' className='col-5 fs-5 font-monospace rounded shadow border' style={{ height: '82px', backgroundColor: '#F8F9FA' }}>
                            <p className='my-auto pt-4'>Total Product Sold</p>
                        </div>
                    </div>
                    <div className='row rounded mt-3' style={{ width: '100%', height: '82px' }}>
                        <div id='revTab' className='col-5 fs-5 font-monospace me-4 rounded shadow border' style={{ height: '82px', backgroundColor: '#F8F9FA' }}>
            ...
            <br />
            <div className='ms-3 shadow border rounded' style={{backgroundRepeat:'no-repeat',backgroundSize:'cover', backgroundImage: `url(${graphimg})`, width:'86%',height:'450px' }}></div>
